...
puts "--- city_names.size ---#{city_names.size}"
puts "--- city_names.sample ---#{city_names.sample}"
...
10.times do |n|
  10.times do |m|
    ...
    if m % 2 == 0
      c.personal_phones.create!( number: 
                                sprintf( "090-0000-%04d", n * 10 + m ) )
    end
